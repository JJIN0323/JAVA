...
public class TeacherQuestion {
    public static void main(String[] args) {
         ...
         *
         *   Application01
         *   - main(args:String[]): void 설명 : 모든 메서드는 main 함수에서 호출하여 출력한다.
         *   // 메서드 호출 확인용 메서드 호출
         *   // 10, 20 두 개의 정수를 매개변수로 하여 두 수를 더하는 메서드 호출 후 리턴값 출력
         *   // 10, 5 두 개의 정수를 매개변수로 하여 두 수의 차를 구하는 메서드 호출 후 리턴값 출력
         *   // 10, 5 두 개의 정수를 매개변수로 하여 두 수의 곱을 구하는 메서드 호출 후 리턴값 출력
         *   // 10, 5 두 개의 정수를 매개변수로 하여 두 수의 몫을 구하는 메서드 호출 후 리턴값 출력
         *   실행 결과
         *   - 메서드 호출 확인
         *   - 10과 20의 합 : 30
         *   - 10과 5의 차 : 5
